...
export default function ProgressTracking() {
  // Live Convex data
  const teamProgress  = useQuery(api.progress.getTeamProgress);
  const liveScore     = useQuery(api.analytics.getLiveProductivityScore);
  const overdue       = useQuery(api.analytics.getOverdueCount);
  const upcoming      = useQuery(api.progress.getUpcomingDeadlines);
  const dashStats     = useQuery(api.dashboard.getStats);
