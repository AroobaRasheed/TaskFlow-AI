...
export default function Dashboard() {
  ...
  const liveStats = useQuery(api.dashboard.getStats);
  const recentTasks = useQuery(api.dashboard.getRecentActivity);
  const distribution = useQuery(api.dashboard.getStatusDistribution);
  const upcomingDeadlines = useQuery(api.progress.getUpcomingDeadlines);
